package ozbek.BYT8.Lab2B.RefactoringExercises.exercise06.src;
...
public class TicTacToe {
	...
	// 2nd for loop deleted and added if statement to 1st loop
	// By the way we get rid of one for loop
